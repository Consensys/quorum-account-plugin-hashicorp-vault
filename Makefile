...
itest: clean tools build zip
	 gotestsum --format standard-verbose -- github.com/consensys/quorum-account-plugin-hashicorp-vault/internal/test/integration -tags integration
	 gotestsum --format standard-verbose -- github.com/consensys/quorum-account-plugin-hashicorp-vault/internal/test/integration -tags clefintegration
