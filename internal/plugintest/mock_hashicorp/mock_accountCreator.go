...
// Source: github.com/goquorum/quorum-plugin-hashicorp-account-store/internal/vault/hashicorp (interfaces: AccountCreator)

// Package mock_hashicorp is a generated GoMock package.
package mock_hashicorp
...
func (m *MockAccountCreator) ImportECDSA(arg0 *ecdsa.PrivateKey, arg1 hashicorp.VaultAccountConfig) (accounts.Account, string, error) {
	m.ctrl.T.Helper()
...
func (m *MockAccountCreator) NewAccount(arg0 hashicorp.VaultAccountConfig) (accounts.Account, string, error) {
	m.ctrl.T.Helper()
