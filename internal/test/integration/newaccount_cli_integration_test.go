...
func Test_CLI_KV_CreateAccount_NewPath_ValidOverwriteProtection(t *testing.T) {
...
func Test_CLI_KV_CreateAccount_NewPath_InvalidOverwriteProtection(t *testing.T) {
	dirs := prepareDirs(t, testDirName, t.Name())
...
func Test_CLI_KV_CreateAccount_ExistingPath_ValidOverwriteProtection(t *testing.T) {
	dirs := prepareDirs(t, testDirName, t.Name())
...
func Test_CLI_KV_CreateAccount_ExistingPath_InvalidOverwriteProtection(t *testing.T) {
	dirs := prepareDirs(t, testDirName, t.Name())
...
func Test_CLI_Signer_CreateAccount_NewPath(t *testing.T) {
	dirs := prepareDirs(t, testDirName, t.Name())
...
func Test_CLI_Signer_CreateAccount_ExistingPath_NotAllowed(t *testing.T) {
	dirs := prepareDirs(t, testDirName, t.Name())
	...
	require.NotContains(t, out, "updating existing secrets is not supported")
