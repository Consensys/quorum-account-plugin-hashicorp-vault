...
type SignHashWithPassphraseRequest struct {
	SignHashRequest      *SignHashRequest `protobuf:"bytes,1,opt,name=signHashRequest,proto3" json:"signHashRequest,omitempty"`
	Passphrase           string           `protobuf:"bytes,2,opt,name=passphrase,proto3" json:"passphrase,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
...
func (m *SignHashWithPassphraseRequest) GetSignHashRequest() *SignHashRequest {
	if m != nil {
		return m.SignHashRequest
	}
	return nil
}
...
type SignTxWithPassphraseRequest struct {
	SignTxRequest        *SignTxRequest `protobuf:"bytes,1,opt,name=signTxRequest,proto3" json:"signTxRequest,omitempty"`
	Passphrase           string         `protobuf:"bytes,2,opt,name=passphrase,proto3" json:"passphrase,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
...
func (m *SignTxWithPassphraseRequest) GetSignTxRequest() *SignTxRequest {
	if m != nil {
		return m.SignTxRequest
	}
	return nil
}
...
var fileDescriptor_df2490657d73dbfd = []byte{
	...
	,
}
